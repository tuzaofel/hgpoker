...
import IconEmployeeGroup from './icons/IconAgenda.vue';
import IconExclamation from './icons/IconCup.vue';
      ...
      <ul>
        ...
        <li>
          <router-link to="/ranking">
            <IconExclamation />
            <Transition name="fade">
              <span v-show="isSidebarOpen">Ranking</span>
            </Transition>
          </router-link>
        </li>
        <li>
          <router-link to="/torneios">
            <IconEmployeeGroup />
            <Transition name="fade">
              <span v-show="isSidebarOpen">Torneios</span>
            </Transition>
          </router-link>
        </li>
        <li>
